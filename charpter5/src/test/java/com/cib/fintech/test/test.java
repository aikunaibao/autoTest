package com.cib.fintech.test;

import com.cib.fintech.Interface.Common;
import com.cib.fintech.Interface.getCityWeather;
...
public class test {
    ...
    public void getBeiJing_Succ() throws IOException{
        ...
        weatherinfo=Common.getJsonValue(httpResult, "province");
